      ...
      <Column className="bg-white_A700 flex flex-col font-manrope items-center justify-start mx-[auto] w-[100%]">
        ...
        <Column className="flex flex-col items-center justify-start w-[100%]">
          <Column className="bg-gray_51 flex flex-col items-center justify-start sm:p-[15px] md:p-[49px] p-[72px] w-[100%]">
            <Column className="flex flex-col items-center justify-start max-w-[1200px] sm:mb-[3px] md:mb-[4px] mb-[7px] ml-[auto] mr-[auto] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Column className="flex flex-col justify-start w-[100%]">
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between sm:mt-[23px] md:mt-[30px] mt-[44px] w-[100%]">
                  <Stack className="h-[511px] relative w-[32%]">
                    <Stack className="absolute h-[511px] w-[100%]">
                      <GoogleMap
                        className="absolute sm:h-[273px] md:h-[352px] h-[511px] rounded-radius10 w-[100%]"
                        showMarker={false}
                      ></GoogleMap>
                      <Img
                        src="images/img_group100000153.svg"
                        className="absolute h-[427px] inset-y-[0] max-w-[100%] my-[auto] right-[6%] sm:w-[100%] w-[84%]"
                        alt="Group100000153"
                      />
                    </Stack>
                    <Column className="absolute bg-white_A700 border border-bluegray_100 border-solid flex flex-col items-center justify-start left-[7%] sm:mx-[0] md:p-[13px] sm:p-[15px] p-[20px] rounded-radius10 top-[30%] sm:w-[100%] w-[78%]">
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-end ml-[auto] sm:mt-[42px] md:mt-[55px] mt-[80px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[66%]">
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-evenly sm:mx-[0] sm:px-[0] sm:w-[100%] w-[32%]">
                    <Button
                  ...
                  <Button
                    className="flex items-center justify-center md:ml-[278px] min-w-[18%] ml-[405px] sm:ml-[215px] text-center w-[max-content]"
                    rightIcon={
                      <Img
          ...
          <Footer className="bg-white_A700 mt-[12px] sm:mt-[6px] md:mt-[8px] w-[100%]" />
        </Column>
      </Column>
    </>
  );
