  ...
  return (
    <>
      <footer className={props.className}>
        <Column className="flex flex-col justify-start sm:mb-[41px] md:mb-[52px] mb-[77px] ml-[120px] sm:ml-[63px] md:ml-[82px] mr-[121px] sm:mr-[64px] md:mr-[83px] mt-[100px] sm:mt-[53px] md:mt-[68px] sm:w-[100%] w-[84%]">
          ...
          <Text className="font-manrope font-semibold ml-[4px] mt-[120px] sm:mt-[63px] md:mt-[82px] text-[16px] text-gray_900 w-[auto]">
